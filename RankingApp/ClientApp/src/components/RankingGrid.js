    ...
    function createCellsForRow(rowNum) {
        ...
        function pushCellMarkupToArr(cellCollection, rankNum, rowLabel) {
            if (rankNum > 0) {
                ...
                /* Adds the relavant image as a child elemeent w/in the target cell. The image represents an item that has its ranking property set to the ranking value denoted by the appropriate grid cell I.e. the target cel wi/in the ranking grid.*/
